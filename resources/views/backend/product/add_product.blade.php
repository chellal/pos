                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input value="{{ old('product_code') }}" type="text" name="product_code"
                                                    id="product_code" class="form-control ">
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input value="{{ old('product_garage') }}" type="text"
                                                    id="product_garage" name="product_garage" class="form-control ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input value="{{ old('product_store') }}" type="text" id="product_store"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="buying_date" class="form-label">Buing Date</label>
                                                <input value="{{ old('buying_date') }}" type="date" name="buying_date"
                                                    id="buying_date" class="form-control ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input value="{{ old('expire_date') }}" type="date" name="expire_date"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input value="{{ old('buying_price') }}" type="text" name="buying_price"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input value="{{ old('selling_price') }}" type="text" id="selling_price"
