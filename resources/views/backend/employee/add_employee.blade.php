                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="experience"
                                                    ...
                                                    <option value="1" {{ '1' == old('experience') ? 'selected' : '' }}>
                                                        1 Year
                                                    </option>
                                                    <option value="2"
                                                        {{ '2' == old('experience') ? 'selected' : '' }}>2 Years
                                                    </option>
                                                    <option value="3"
                                                        {{ '3' == old('experience') ? 'selected' : '' }}>3 Years
                                                    </option>
                                                    <option value="4"
                                                        {{ '4' == old('experience') ? 'selected' : '' }}>4 Years
                                                    </option>
                                                </select>
                                                @error('experience')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input value="{{ old('salary') }}" type="text" name="salary"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input value="{{ old('vacation') }}" type="text" name="vacation"
