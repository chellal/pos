                            ...
                            <ol class="breadcrumb m-0">
                                <h4>
                                    ...
                                    <a href="{{ route('employee.attend.list') }}" class="btn btn-primary float-sm-right"> <i
                                            class="fas fa-list"></i>Edit Employee Attendance</a>
                                </h4>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center btn present_all"
                                                style="display: table-cell;background-color:#3276e3;color: white">Present
                                            </th>
                                            <th class="text-center btn leave_all"
                                                style="display: table-cell;background-color:#3276e3;color: white">Leave</th>
                                            <th class="text-center btn absent_all"
                                                style="display: table-cell;background-color:#3276e3;color: white">Absent
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                ...
                                                <td colspan="3">
                                                    <div class="switch-toggle switch-3 switch-candy">
                                                        <input class="present" id="present{{ $key }}"
                                                            ...
                                                            type="radio"
                                                            {{ $item->attend_status == 'Present' ? 'checked' : '' }}>
